...
def train(feature_gnn_path, feature_gnn_drop_path, graph_search_path):
    ...
    feature_diff = cos(feature_gnn, feature_gnn_drop)
    ...
    embeds_drop = torch.cat((feature_exps_drop, feature_gnn_drop), 1)
