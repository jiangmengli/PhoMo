...
def train(feature_gnn_path, class_num = 'binary', predition='TON', matching_path='graph_match_judge.npy', MLF= True):
    ...
    feature_exps = np.zeros((363,10),dtype=float)
    labels = np.zeros((363),dtype=int)
    ...
    idx_test = np.linspace(0, 362, num=363, endpoint=True, dtype=int)
