...
def cli_main():
    ...
    # data
    # ------------
    dm = GraphDataModule.from_argparse_args(args) # GH: load dataset

    # ------------
    # model
    # ------------
    if args.checkpoint_path != '':
        model = Graphormer.load_from_checkpoint( # GH:load model
    ...
    checkpoint_callback = ModelCheckpoint( # GH:set how to save models
        monitor=metric,
        dirpath=dirpath,
...
if __name__ == '__main__':
    # print("graphormer entry cwd is ", os.getcwd())
    cli_main()
