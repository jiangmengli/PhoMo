...
def main():
    ...
    parser.add_argument('--checkpoint_saved_dir', type=str, default='./checkpoint-gin.pt',
                        help='directory to save checkpoint')
    ...
    train_idx = torch.arange(0, 334, 1)
    valid_idx = torch.arange(0, 334, 1)
    test_idx = torch.arange(0, 334, 1)
    split_idx ={
        'train':train_idx,
        'valid': valid_idx,
        'test': test_idx,
    ...
    if args.train_subset:
        ...
        train_loader = DataLoader(dataset[split_idx["train"][subset_idx]], batch_size=args.batch_size, shuffle=False,
    ...
    checkpoint_path = args.checkpoint_saved_dir
