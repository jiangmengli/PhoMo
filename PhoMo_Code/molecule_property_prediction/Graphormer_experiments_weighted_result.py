...
import feature_test_weighted_MLF as feature_test_judge_new
import graph_search_get
import torch
...
if __name__ == '__main__':
    ...
    if not skip:
        ...
        os.system(cmd)
        # 在此处进行最终结果的计算
        print_r = feature_test_judge_new.train("./graphormer_output_np_ori_test.npy", class_num='multi', predition='TON', MLF=True, sample_total_num=364)
