...
if __name__ == '__main__':
    ...
    if not skip:
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gin_vFalse_output_np.npy", class_num='multi', MLF=True) )

        accs = np.array(accs)

        print("=== result === \n gin MLF test acc is ", accs.mean() , " std is ", accs.std())
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gin_vFalse_output_np.npy", class_num='multi', MLF=False) )

        accs = np.array(accs)

        print("=== result === \n gin no MLF test acc is ", accs.mean() , " std is ", accs.std())
        ...
        #     os.system(cmd)
        #
        #     accs.append( both_test.train("./GIN/GIN-PCQimp/gin_vFalse_output_np.npy", class_num='multi', MLF=True ) )
        #
        # accs = np.array(accs)
        #
    ...
    if not skip:
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gin_vTrue_output_np.npy", class_num='multi', MLF=True) )

        accs = np.array(accs)

        print("=== result === \n gin virtual MLF test acc is ", accs.mean() , " std is ", accs.std())
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gin_vTrue_output_np.npy", class_num='multi', MLF=False) )

        accs = np.array(accs)

        print("=== result === \n gin virtual no MLF test acc is ", accs.mean(), " std is ", accs.std())
    ...
    if not skip:
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gcn_vFalse_output_np.npy", class_num='multi', MLF=True) )

        accs = np.array(accs)

        print("=== result === \n gcn MLF test acc is ", accs.mean() , " std is ", accs.std())
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gcn_vFalse_output_np.npy", class_num='multi', MLF=False) )

        accs = np.array(accs)

        print("=== result === \n gcn no MLF test acc is ", accs.mean() , " std is ", accs.std())
    ...
    if not skip:
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gcn_vTrue_output_np.npy", class_num='multi', MLF=True) )

        accs = np.array(accs)

        print("=== result === \n gcn virtual MLF test acc is ", accs.mean() , " std is ", accs.std())
        ...
        for i in range(5):
            ...
            accs.append( feature_test.train("./GIN/GIN-PCQimp/gcn_vTrue_output_np.npy", class_num='multi', MLF=False) )

        accs = np.array(accs)

        print("=== result === \n gcn virtual no MLF test acc is ", accs.mean() , " std is ", accs.std())
