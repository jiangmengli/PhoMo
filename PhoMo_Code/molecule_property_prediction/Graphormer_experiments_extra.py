...
if __name__ == '__main__':
    ...
    if not skip:
        ...
        for i in range(5):
            ...
            print(cmd)
            os.system(cmd)
            accs.append(feature_test.train("./graphormer_output_np_ori_test.npy", class_num='multi',  MLF=True))
        accs = np.array(accs)
        ...
        for i in range(5):
            ...
            print(cmd)
            os.system(cmd)
            accs.append(feature_test.train("./graphormer_output_np_ori_test.npy", class_num='multi', MLF=False))
        accs = np.array(accs)
